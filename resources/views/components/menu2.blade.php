...
<nav class="menuprincipal2">
        <ul class="nave">
            <li><a href="/" title="A zecon">A ZECON</a></li>
            <li><a href="/empreendimentos" title="empreendimentos">EMPREENDIMENTOS</a></li>
    ...
    <div class="topHeader2">
        ...
        <div class="container">
            <div class="esquerda">
                <a href="#head"><img src="{{asset('img/ZECONOriginal.png')}}" alt="zecon construtora" title="Zecon Construtora" class="iconz"></a>
            </div>
